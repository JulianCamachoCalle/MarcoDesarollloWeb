...
--
-- Host: 127.0.0.1    Database: donna_pizza
-- ------------------------------------------------------
...
CREATE TABLE `clientes` (
  ...
  `telefono` varchar(13) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `contactos` VALUES (1,'jose','jose@gmail.com','972154748');
...
CREATE TABLE `sugerencias` (
  `cod_suge` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL,
  `descripcion` varchar(150) DEFAULT NULL,
  PRIMARY KEY (`cod_suge`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sugerencias` VALUES (1,'jose','jose@gmail.com','hola');
...
-- Dump completed on 2024-10-28 22:46:48
